    ...
    <div>
        <div class="login-wrapper" id="loginWrapper" style="display: block; min-height: initial;">
            ...
            <section class="avatar-wrapper" id="avatarWrapper">
                ...
                <footer class="footer">
                    <a href="https://m.weibo.cn/reg/index?&amp;vt=4&amp;wm=3349&amp;wentry=&amp;backURL=https%3A%2F%2Fm.weibo.cn%2F%3Fjumpfrom%3Dweibocom">注册帐号</a><a href="https://passport.weibo.cn/forgot/forgot?entry=wapsso&amp;from=0&amp;r=https%3A%2F%2Fm.weibo.cn%2F">忘记密码</a>
                </footer>
        </div>
    </div>
</template>
...
@media only screen and (-webkit-min-device-pixel-ratio: 2) {
    .welcome-wrapper .btnQQ .icon {
        background-image: url("/images/weibo/signin/icon_2x.png");
    }
}
